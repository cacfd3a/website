...
KeyboardKit 10.2 is out! This release introduces a [new dictation engine]({{page.article-dictation}}) and new settings, as well as bug fixes and improvements.
...
There are many new settings, like `isCharacterPreviewEnabled` and `isPredictiveTextEnabled` keyboard settings, and `isNextCharacterPredictionEnabled` autocomplete setting.
